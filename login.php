...
<main class="conteudo">
    <form action="entrar.php" class="form-container">
    ...
    <form action="esqueciminhasenha.php">

        <center><button type="submit" class="btn">Esqueci minha senha</button></center>
        <div class="icon-bar">
            <a href="eventos.php"><i class="fa fa-calendar" aria-hidden="true" alt="Eventos"></i></i></a>
            <a href="didaticos.php"><i class="fa fa-book" aria-hidden="true" alt="Ensino"></i></a>
            <a href="index.php"><i class="fa fa-home" alt="Inicio"></i></a>
            <a href="galeria.php"><i class="fa fa-image" aria-hidden="true" alt="Galeria"></i></i></a>
            <a class="active" href="login.php"><i class="fa fa-sign-in" aria-hidden="true" alt="Entrar"></i></a>
        </div>
    </form>
</main>
