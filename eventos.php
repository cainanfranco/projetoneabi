...
<body>
    ...
    <header>
        ...
        <nav class="menu">
            ...
            <div class="icon-bar">
                <a class="active" href="eventos.php"><i class="fa fa-calendar" aria-hidden="true" alt="Eventos"></i></i></a>
    ...
    <main class="conteudo">
        ...
        <div class="w3-row-padding w3-theme-black">
            <?php
            $result_event = "SELECT * FROM eventos order by id DESC";
            $resultado_event = mysqli_query($conexao, $result_event);
            while ($row_event = mysqli_fetch_array($resultado_event)) {
                $tituloevento =  $row_event['tituloevento'];
                $sobreevento = $row_event['sobreevento'];
                $dataevento = strtotime($row_event['dataevento']);
                $formatdata = date("d/m/Y", $dataevento);
            ?>
                <div class="w3-third w3-section">
                    <div class="w3-card-4">
                        <div class="w3-container w3-white">
                            <h4><?php echo $tituloevento;
                                ?></h4>
                            <p><?php echo $sobreevento;
                                ?></p>
                            <p><?php echo $formatdata;
                                ?></p>
                        </div>
                    </div>
                    </a>
